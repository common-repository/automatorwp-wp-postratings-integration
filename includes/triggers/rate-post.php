...
class AutomatorWP_WP_PostRatings_Rate_Post extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User rates a post', 'automatorwp-wp-postratings-integration' ),
            'select_option'     => __( 'User <strong>rates</strong> a post', 'automatorwp-wp-postratings-integration' ),
            /* translators: %1$s: Post Title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User rates %1$s %2$s time(s)', 'automatorwp-wp-postratings-integration' ), '{post}', '{times}' ),
            /* translators: %1$s: Post Title. */
            'log_label'         => sprintf( __( 'User rates %1$s', 'automatorwp-wp-postratings-integration' ), '{post}' ),
            'action'            => 'rate_post',
